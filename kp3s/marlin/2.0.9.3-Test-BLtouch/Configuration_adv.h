/**
 * Marlin 3D Printer Firmware - KP3
...
//
  ...
  #define BOARD_MAXTEMP          70  // (°C)
    ...
    #define TEMP_BOARD_PIN PC2      // Board temp sensor pin, if not set in pins file.
  #endif
#endif
...
#define ASSISTED_TRAMMING
  ...
  //#define TRAMMING_POINT_XY { {  27, 27 }, { 153,  27 }, { 153, 153 }, { 27, 153 } }
  #define TRAMMING_POINT_XY { {  13+17, 20 }, { 150,  20 }, { 150, 180-45 }, { 13+17, 180-45 } }
...
//#define OPTIBOOT_RESET_REASON
  ...
  #define E1_SERIAL_TX_PIN                  PA3
  #define E1_SERIAL_RX_PIN                  PA3
