...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  15.951
    #define DEFAULT_Ki  0.622
    #define DEFAULT_Kd  102.284
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // KINGROON KP3
  #define DEFAULT_bedKp 62.573
  #define DEFAULT_bedKi 1.448
  #define DEFAULT_bedKd 675.789
...
#define NOZZLE_TO_PROBE_OFFSET { 30, 0, -1.900 }
