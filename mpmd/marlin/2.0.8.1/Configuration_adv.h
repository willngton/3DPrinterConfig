/**
 * Marlin 3D Printer Firmware - MPMD Stable
...
#define MIN_STEPS_PER_SEGMENT 1 //6 willngton
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       300 //380 //580        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  38 //37
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  40 //43 //44
    #define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY
    #define Z_STALL_SENSITIVITY  38 //48 //40
